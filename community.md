    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="ShowcaseCard">
          <h2 class="ShowcaseCard_title">Chat &amp; discussion</h2>
          <p class="ShowcaseCard_body">
            Meet other Kemal and Crystal developers, get quick help and share ideas.
          </p>
          <ul>
      ...
      <div class="col-sm-6">
        <div class="ShowcaseCard">
          <h2 class="ShowcaseCard_title">Issues &amp; contributions</h2>
          <p class="ShowcaseCard_body">
            Report bugs, request features or send pull requests.
          </p>
          <ul>
            <li><a href="https://github.com/kemalcr/kemal/issues">GitHub Issues</a> – bug reports &amp; feature ideas</li>
            <li><a href="https://github.com/kemalcr/kemalcr.com">Website repository</a> – improve these docs</li>
          </ul>
        </div>
      </div>
    </div>
